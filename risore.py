...
def chat(
    ...
    if prompt:
        ...
        console.print("[bold green]Starting interactive chat... (Type 'exit' to quit)[/bold green]")
        chat_history = []
        while True:
            try:
...
@app.command()
def recommend(prompt: str = typer.Argument(..., help="What do you want a recommendation for?")):
