...
def get_rag_chain(
    ...
    if language == "Tamil":
        ...
        - NO GENERIC AI RESPONSES (CRITICAL): You MUST NEVER use generic AI disclaimers such as "As an AI...", "I don't have real-time access...", or "My knowledge cutoff is...". Never break character to complain about system limitations. Users are extremely frustrated by generic AI responses. Be uniquely Risore.
